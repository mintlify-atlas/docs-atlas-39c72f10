...
<CardGroup cols={2}>
  ...
  <Card
    title="SDKs"
    icon="code"
    href="https://beam.apache.org/documentation/sdks/java/"
  >
    Explore language-specific SDKs for Java, Python, Go, and more
  </Card>
  
  <Card
    title="Runners"
    icon="play"
    href="https://beam.apache.org/documentation/runners/capability-matrix/"
  >
  ...
  <Card
    title="Examples"
    icon="flask"
    href="https://github.com/apache/beam/tree/master/examples"
  >
  ...
  <Card
    ...
    icon="graduation-cap"
    href="https://tour.beam.apache.org/"
  >
    Take the Tour of Beam for a comprehensive, interactive learning experience
  </Card>
</CardGroup>
